          ...
          <div className="col-md-2 col-sm-6">
            <div className="footer-menu">
              ...
              <ul className="menu-list list-unstyled">
                ...
                <li><a href="#" className="nav-link">Conditions</a></li>
                <li><a href="#" className="nav-link">Our Journals</a></li>
                <li><a href="#" className="nav-link">Careers</a></li>
                <li><a href="#" className="nav-link">Affiliate Programme</a></li>
                <li><a href="#" className="nav-link">Ultras Press</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="col-md-2 col-sm-6">
            <div className="footer-menu">
              ...
              <ul className="menu-list list-unstyled">
                ...
                <li><a href="#" className="nav-link">Discount Coupons</a></li>
                <li><a href="#" className="nav-link">Stores</a></li>
          ...
          <div className="col-md-2 col-sm-6">
            <div className="footer-menu">
              ...
              <ul className="menu-list list-unstyled">
                ...
                <li><a href="#" className="nav-link">Cookie Guidelines</a></li>
